   ...
   <body class="overflow-x-hidden">
    <!-- start of the navbar -->
      <nav class="flex w-screen">
         <div class="flex lg:justify-between justify-center w-full lg:ml-28 mt-4">
      ...
      <div class="lg:flex lg:justify-between">
         <div>
            <div style="border-radius: 20px;" class="bg-yellow-50 px-10 py-6 mx-8 mt-20 lg:w-full lg:ml-28">
            ...
            <div style="border-radius: 20px;" class="bg-yellow-50 px-10 py-6 mx-8 mt-14 lg:w-full lg:ml-28">
               <div>
    ...
    <!-- start of overview tab rightside "My Plants" + QR Code button -->
    <div>
      <div class="lg:flex lg:justify-between lg:mt-24">
      ...
      <div class="lg:justify-between lg:flex">
         <a class="block lg:hidden" href="#">
            <div style="border-radius: 20px;" class="bg-yellow-50 px-10 py-3 mx-8 mt-10 flex justify-center lg:w-4/12">
        ...
        <!-- Mobile QR Code Button -->
         <div style="border-radius: 20px;" class="bg-yellow-50 px-10 py-3 mx-8 mt-10 flex justify-center w-1/3 h-fit hidden lg:flex">
            <a class="" href="#">
            <img class="w-6 h-fit" src="../images/Vector.png" alt="">
            </a>
         </div>
